 ...
 */
public class JInternalDialog2 extends JInternalFrame {

    Object syncMonitor = new Object();
    BufferedImage fondo;
    public BlurGlass2 glass;
    Object JParent;
    ...
    public JInternalDialog2(Object parent) {
          //setVisible(true);
          init(parent);
    }
    public JInternalDialog2(Object parent, String titulo)
    {
          setTitle(titulo);
          init(parent);
    }
    public JInternalDialog2(Object parent, String titulo, Container contenido)
    {
          //setTitle(titulo);
          init(parent);
    ...
    public void init(Object parent)
    {
          ...
          glass = new BlurGlass2();
          glass.setConFondo(true);
          ...
          try {
            glass.add(this);
            layer.add(glass, JLayeredPane.MODAL_LAYER);
...
class BlurGlass2 extends JPanel {

      private BufferedImage blurBuffer;
      private BufferedImage backBuffer;
      private float alpha  = 0.0f;
      private boolean listo= false;
      private boolean conFondo = false;
      ...
      public void setConFondo(boolean val) { conFondo = val; }
      public void generarFondo(Component componente)
      {
