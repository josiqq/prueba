...
public class DialogoCambio extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setForeground(new Color(235, 236, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Cambio");

        btnContinuar.setText("Continuar [Enter]");

        cambio.setFont(new Font("Tahoma", 1, 36)); // NOI18N
        cambio.setForeground(new Color(255, 255, 255));
        cambio.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        txtEfectivo.setFont(new Font("Tahoma", 1, 36)); // NOI18N
        txtEfectivo.setForeground(new Color(0, 51, 102));
        txtEfectivo.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        total.setFont(new Font("Tahoma", 1, 36)); // NOI18N
        total.setForeground(new Color(255, 255, 255));
        total.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        jLabel1.setFont(new Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new Color(235, 236, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Total");

        jLabel2.setFont(new Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new Color(235, 236, 255));
