...
public class Calendario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        etiquetaCalendario.setForeground(new Color(255, 255, 255));
        ...
        jxmvCalendario.setBackground(new Color(0, 0, 51));
        jxmvCalendario.setForeground(new Color(255, 255, 255));
        //jxmvCalendario.setAntialiased(true);   //Obsoleto en swingx > 0.9.5
        jxmvCalendario.setDaysOfTheWeekForeground(new Color(204, 204, 204));
        jxmvCalendario.setFont(new java.awt.Font("Arial", 0, 24));
        jxmvCalendario.setMonthStringBackground(new Color(0, 0, 153));
        jxmvCalendario.setMonthStringForeground(new Color(204, 204, 204));
        //jxmvCalendario.setSelectionBackground(new java.awt.Color(51, 0, 153)); //Obsoleto
        jxmvCalendario.setSelectionBackground(new Color(51, 0, 153));
