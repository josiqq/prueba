...
public class Calculadora extends javax.swing.JInternalFrame implements java.awt.datatransfer.ClipboardOwner {
    ...
    private void initComponents() {
        ...
        etiquetaCalculadora.setForeground(new Color(255, 255, 255));
        ...
        jcalCalculadora.setDisplayBackground(new Color(0, 0, 102));
        jcalCalculadora.setDisplayForeground(new Color(255, 255, 255));
